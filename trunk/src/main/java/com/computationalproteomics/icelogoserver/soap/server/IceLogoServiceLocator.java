...
public class IceLogoServiceLocator extends org.apache.axis.client.Service implements com.computationalproteomics.icelogoserver.soap.server.IceLogoService {
    ...
    public com.computationalproteomics.icelogoserver.soap.server.IceLogo geticelogo(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.computationalproteomics.icelogoserver.soap.server.IcelogoSoapBindingStub _stub = new com.computationalproteomics.icelogoserver.soap.server.IcelogoSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.computationalproteomics.icelogoserver.soap.server.IceLogo.class.isAssignableFrom(serviceEndpointInterface)) {
                com.computationalproteomics.icelogoserver.soap.server.IcelogoSoapBindingStub _stub = new com.computationalproteomics.icelogoserver.soap.server.IcelogoSoapBindingStub(new java.net.URL(icelogo_address), this);
                _stub.setPortName(geticelogoWSDDServiceName());
                return _stub;
            }
        }
