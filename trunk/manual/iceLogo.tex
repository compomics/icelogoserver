...
\date{}
 \url{http://iomics.ugent.be/icelogoserver/main.html}
\end{center}
\end{titlepage}
...
\caption{Change this \htmladdnormallink{example}{http://iomics.ugent.be/icelogoserver/logo.html?example=1}.}
\label{example1}
\end{center}
\end{figure}
...
\caption{Change this \htmladdnormallink{example}{http://iomics.ugent.be/icelogoserver/logo.html?example=2}.}
\label{example2}
\end{center}
\end{figure}
...
\caption{Change this \htmladdnormallink{example}{http://iomics.ugent.be/icelogoserver/logo.html?example=3}.}
\label{example3}
\end{center}
\end{figure}
...
\caption{Change this \htmladdnormallink{example}{http://iomics.ugent.be/icelogoserver/logo.html?example=4}.}
\label{example4}
\end{center}
\end{figure}
...
\caption{Change this \htmladdnormallink{example}{http://iomics.ugent.be/icelogoserver/logo.html?example=5}.}
\label{example5}
\end{center}
\end{figure}
...
\caption{Change this \htmladdnormallink{example}{http://iomics.ugent.be/icelogoserver/logo.html?example=6}.}
\label{example6}
\end{center}
\end{figure}
...
\paragraph{}A SOAP server can be accessed via \url{http://iomics.ugent.be/icelogoserver/services/icelogo}. More information about this SOAP server can be found on \url{http://iomics.ugent.be/icelogoserver/soap.html}. The wsdl file describing these services and methods can be found on \url{http://iomics.ugent.be/icelogoserver/IceLogo.wsdl}. 
\backmatter
